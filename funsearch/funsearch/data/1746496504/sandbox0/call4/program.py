...
def find_best_route(_distances: np.ndarray) -> tuple[int, ...]:
    ...
    # Ensure reproducibility by setting a seed for any random number generators used.
    np.random.seed(42)

    # Perform local search on the initial solution generated by the hybrid heuristic.
    best_route = local_search(initial_route)
